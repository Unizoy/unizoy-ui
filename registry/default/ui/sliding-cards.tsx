...
const SlidingCards: React.FC<SlidingCardsProps> = ({ 
  ...
  useGSAP(() => {
    ...
    const minHeight = minHeightValue !== undefined 
    ? minHeightValue 
  ...
  return (
    <div
      ...
      className={cn("relative h-[150vh]  flex flex-col justify-start items-center bg-cover bg-center",parentClassName)}
    >
      <h1 className={cn('text-[4.5rem] text-white my-20 font-semibold',headingClassName)} >{headingText}</h1>
      <div className={cn("relative flex flex-col justify-center items-center mt-20",parentContentClassName)}>
            ...
            >
              ...
              >
                ...
                <div className="flex gap-2 text-white items-center">
                  <div className={`flex justify-center items-center w-9 h-9 rounded-full p-2 ${item.background}`}>
