...
const CopyIcon: React.FC<CopyIconProp> = ({
  ...
  if (check && hiddenIcon && window.getComputedStyle(hiddenIcon).opacity === "0") return;
  ...
  return (
    ...
    >
      ...
      onMouseEnter={()=>handleMouseEnter(true)}
       ref={hiddenIconsRef} className="flex flex-col items-center">
        ...
        <MdOutlineHtml
          ...
          onClick={() => {
            ...
            if (hiddenIcon && window.getComputedStyle(hiddenIcon).opacity === "0") return;
