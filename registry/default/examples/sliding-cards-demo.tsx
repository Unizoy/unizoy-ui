...
import { SlidingCards } from '@/registry/default/ui/sliding-cards';
export default function SlidingCardsDemo () {
  ...
  const items = [
    ...
    },
    {
      ...
      description: "Unizoy provided creative digital strategies that transformed our marketing approach and drove measurable growth.",
      name: "Claire S.",
      background: "bg-[#BCFFBB]",
    },
    {
      title: "Reliable & Professional",
      description: "Working with Unizoy has been a pleasure—they consistently deliver quality work on time, every time.",
      name: "James D.",
