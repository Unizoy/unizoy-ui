...
const RotatingText = ({ text ,scrollerRef,start="top top",end="+=300",scrub=1,markers=false,className}: RotatingTextProps) => {
  ...
  return (
    <div
      ref={mainRef}
      className={cn(" h-screen text-9xl",className," flex justify-center items-center  ")}
